...
import { Plus, FileText, Eye, Pencil, X } from "lucide-react";
...
const TalentRequestsPage = () => {
  ...
  const displayRequests: SampleRequest[] = talentRequests.length > 0
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea className="mt-1.5" rows={3} placeholder="Describe what academic expertise you need and for what purpose..." value={form.description} onChange={e => setForm(f => ({ ...f, description: e.target.value }))} />
              </div>
              <div>
